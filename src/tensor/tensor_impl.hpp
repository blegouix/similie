...
template <class Dom>
struct RelabelizeIndexesInDomain<Dom, ddc::detail::TypeSeq<>, ddc::detail::TypeSeq<>>
{
    using type = Dom;
};
        ...
        ddc::detail::TypeSeq<HeadNewIndex, TailNewIndex...>>
{
    using type = std::conditional_t<
            ...
            typename RelabelizeIndexesInDomain<
                    typename RelabelizeIndexInDomain<Dom, HeadOldIndex, HeadNewIndex>::type,
                    ddc::detail::TypeSeq<TailOldIndex...>,
                    ddc::detail::TypeSeq<TailNewIndex...>>::type,
            typename RelabelizeIndexInDomain<Dom, HeadOldIndex, HeadNewIndex>::type>;
};
        ...
        NewIndexes>
{
    using type = Tensor<
            ElementType,
            typename RelabelizeIndexesInDomain<Dom, OldIndexes, NewIndexes>::type,
            LayoutStridedPolicy,
            MemorySpace>;
};
...
template <
        ...
        class LayoutStridedPolicy,
        class MemorySpace>
relabelize_indexes_of_t<
        Tensor<ElementType, ddc::DiscreteDomain<DDim...>, LayoutStridedPolicy, MemorySpace>,
        OldIndexes,
        NewIndexes>
relabelize_indexes_of(
        Tensor<ElementType, ddc::DiscreteDomain<DDim...>, LayoutStridedPolicy, MemorySpace>
                old_tensor)
{
    if constexpr (I != ddc::type_seq_size_v<OldIndexes>) {
        return relabelize_indexes_of<OldIndexes, NewIndexes, I + 1>(
                relabelize_indexes_of_t<
                        Tensor<ElementType,
                               ddc::DiscreteDomain<DDim...>,
                               LayoutStridedPolicy,
                        ...
                        NewIndexes>(
                        old_tensor.data_handle(),
                        typename detail::RelabelizeIndexesInDomain<
                                ddc::DiscreteDomain<DDim...>,
                                OldIndexes,
                                NewIndexes>::
