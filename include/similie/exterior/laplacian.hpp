...
template <
        ...
        tensor::TensorNatIndex LaplacianDummyTag,
        ...
        MetricType inv_metric)
{
    ...
    static_assert(tensor::is_covariant_v<LaplacianDummyTag>);

    // Derivative
    [[maybe_unused]] tensor::TensorAccessor<coboundary_index_t<LaplacianDummyTag, CochainTag>>
            derivative_accessor;
    ddc::cartesian_prod_t<
            typename TensorType::non_indices_domain_t,
            ddc::DiscreteDomain<coboundary_index_t<LaplacianDummyTag, CochainTag>>>
