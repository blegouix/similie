...
TEST(Tensor, YoungTableauIndexing)
{
    ...
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, X, X>()), 0.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, X, Y>()), 1.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, X, Z>()), 2.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Y, X>()), 1.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Y, Y>()), 3.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Y, Z>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Z, X>()), 2.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Z, Y>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<X, Z, Z>()), 5.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, X, X>()), 1.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, X, Y>()), 3.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, X, Z>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Y, X>()), 3.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Y, Y>()), 6.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Y, Z>()), 7.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Z, X>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Z, Y>()), 7.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Y, Z, Z>()), 8.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, X, X>()), 2.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, X, Y>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, X, Z>()), 5.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Y, X>()), 4.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Y, Y>()), 7.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Y, Z>()), 8.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Z, X>()), 5.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Z, Y>()), 8.);
    EXPECT_FLOAT_EQ(tensor.get(tensor.access_element<Z, Z, Z>()), 9.);
    ...
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, X, X>()), 0.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, X, Y>()), 1.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, X, Z>()), 2.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Y, X>()), 1.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Y, Y>()), 3.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Y, Z>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Z, X>()), 2.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Z, Y>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<X, Z, Z>()), 5.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, X, X>()), 1.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, X, Y>()), 3.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, X, Z>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Y, X>()), 3.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Y, Y>()), 6.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Y, Z>()), 7.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Z, X>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Z, Y>()), 7.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Y, Z, Z>()), 8.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, X, X>()), 2.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, X, Y>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, X, Z>()), 5.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Y, X>()), 4.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Y, Y>()), 7.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Y, Z>()), 8.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Z, X>()), 5.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Z, Y>()), 8.);
    EXPECT_FLOAT_EQ(uncompressed.get(natural_accessor.access_element<Z, Z, Z>()), 9.);
}
#endif
