...
TEST(CsrDynamic, Csr2Dense)
{
    ...
    tensor(tensor_accessor.access_element<X, Z, Y>()) = 2.;
    tensor(tensor_accessor.access_element<Y, X, X>()) = 3.;
    tensor(tensor_accessor.access_element<Y, X, Z>()) = 4.;
    tensor(tensor_accessor.access_element<Y, Z, Z>()) = 5.;
    tensor(tensor_accessor.access_element<Z, X, Z>()) = 6.;
    tensor(tensor_accessor.access_element<Z, Y, Y>()) = 7.;
    tensor(tensor_accessor.access_element<Z, X, Y>()) = 8.;
    ...
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, X, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, X, Y>()), 1.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, X, Z>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Y, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Y, Y>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Y, Z>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Z, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Z, Y>()), 2.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<X, Z, Z>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, X, X>()), 3.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, X, Y>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, X, Z>()), 4.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Y, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Y, Y>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Y, Z>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Z, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Z, Y>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Y, Z, Z>()), 5.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, X, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, X, Y>()), 8.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, X, Z>()), 6.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Y, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Y, Y>()), 7.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Y, Z>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Z, X>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Z, Y>()), 0.);
    EXPECT_EQ(dense_tensor.get(tensor_accessor.access_element<Z, Z, Z>()), 9.);
}
